    ...
    *,
    ...
    obj = {
        ...
        "dwi": {
            ...
            "evaluation_mask": dwi.get("evaluation_mask", "brain & WLS_valid"),
            "max_voxels": dwi.get("max_voxels"),
            "seed": dwi.get("seed"),
            "n_eval_voxels": dwi.get("n_eval_voxels"),
            "n_sampled_voxels": dwi.get("n_sampled_voxels"),
        },
        "training": {
...
def metrics_json_to_summary_row(metrics: dict[str, Any], *, ok: bool = True, error: str = "") -> dict[str, Any]:
    ...
    row: dict[str, Any] = {
        ...
        "n_eval_voxels": dwi.get("n_eval_voxels"),
        "n_sampled_voxels": dwi.get("n_sampled_voxels"),
        "evaluation_mask": dwi.get("evaluation_mask"),
